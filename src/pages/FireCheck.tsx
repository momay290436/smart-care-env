...
import * as XLSX from "xlsx"; // ดึงไลบรารี xlsx มาใช้จัดทำไฟล์ Excel โดยตรงในไฟล์นี้
...
export default function FireCheck() {
  ...
  // ฟังก์ชันเขียนขึ้นตรงเพื่อ Export ไปที่ Excel แบบไม่ต้องพึ่งพาไฟล์ภายนอก
  const handleExport = () => {
    ...
    // จัดรูปแบบโครงสร้างหัวตารางภาษาไทย
    ...
    // ดำเนินการสร้าง Workbook และดาวน์โหลดไฟล์ผ่านตัวไลบรารี xlsx
  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 py-6 space-y-6">
      ...
      {/* แผงกล่องข้อมูลถังดับเพลิงและสายน้ำดับเพลิง */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {/* สรุปประเภทถังดับเพลิง */}
