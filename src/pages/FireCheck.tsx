...
export default function FireCheck() {
  ...
  // ข้อมูลสายน้ำดับเพลิง 8 จุด (คงที่ตามเงื่อนไขของระบบ)
  ...
  return (
    <div className="space-y-4 pb-6">
      ...
      {/* โครงสร้างส่วนกล่องสถิติ 3 กล่องเดิมของพี่ */}
      ...
      {/* ================= แทรกโค้ดส่วนข้อมูลที่เพิ่มเข้าไปตามคำสั่ง ================= */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        {/* สรุปข้อมูลถังดับเพลิง */}
        <Card className="shadow-card border border-border/50 bg-white rounded-3xl overflow-hidden md:col-span-1">
          <CardHeader className="bg-rose-50/50 border-b border-border/20 py-3 px-4">
          ...
          <CardContent className="p-4 space-y-3">
            <div className="text-center bg-rose-50/30 py-2 rounded-xl border border-rose-100/50">
              <span className="text-[10px] font-semibold text-muted-foreground block">จำนวนถังรวม</span>
              <span className="text-2xl font-black text-rose-600">87</span>
              <span className="text-xs text-muted-foreground font-medium ml-1">ถัง</span>
            </div>
        ...
        <Card className="shadow-card border border-border/50 bg-white rounded-3xl overflow-hidden md:col-span-2">
          <CardHeader className="bg-blue-50/50 border-b border-border/20 py-3 px-4 flex flex-row justify-between items-center">
          ...
          <CardContent className="p-3">
            <div className="mb-2 text-[11px] font-semibold text-muted-foreground flex items-center gap-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-1.5 max-h-[135px] overflow-y-auto pr-1">
