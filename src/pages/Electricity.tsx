        ...
        <Card className="w-full shadow-sm border border-slate-200/80 bg-white rounded-2xl overflow-hidden">
          ...
          <CardContent className="space-y-3 pt-3 px-4 pb-4">
            {!isScanning ? (
              ...
              <div className="relative max-w-md mx-auto aspect-square w-full border-4 border-indigo-500 rounded-xl overflow-hidden shadow-inner bg-black">
                <div id="reader" className="w-full h-full"></div>
                <Button onClick={() => window.location.reload()} className="absolute top-2 right-2 rounded-full h-7 w-7 p-0 z-10" size="sm" variant="destructive"><X className="h-3 w-3"/></Button>
              </div>
            )}
