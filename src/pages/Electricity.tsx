...
export default function Electricity() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // คำนวณค่าไฟที่ใช้จริงแบบรองรับมิเตอร์ 4 หลักวนรอบ (ป้องกันค่าติดลบตอนส่งเข้าเซฟ)
      const calculatedUnitsUsed = currentVal >= prevVal 
        ? currentVal - prevVal 
        : (10000 - prevVal) + currentVal;
      ...
      const insertData: any = {
        ...
        units_used: calculatedUnitsUsed, // ส่งค่าที่คำนวณวนรอบแล้วไปแทนที่ระบบอัตโนมัติของเบส
