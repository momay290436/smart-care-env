...
export default function Electricity() {
  ...
  // ดำเนินการบันทึกข้อมูลเข้าสู่ฐานข้อมูล (แก้ไข: ถอดฟิลด์ units_used ออกเพื่อให้ Database ของพี่มณีวรรณคำนวณแบบ Generated อัตโนมัติ)
  const handleSave = async () => {
    ...
    try {
      ...
      // ตรวจสอบความถูกต้องเบื้องต้นก่อนส่งบันทึก
      ...
      // เอาฟิลด์ units_used ออกจากคำสั่ง insert เพื่อไม่ให้ชนกับระบบอัตโนมัติในฐานข้อมูล
