...
export default function Electricity() {
  ...
  // ดำเนินการบันทึกข้อมูลเข้าสู่ฐานข้อมูล (แก้ไข: ถอดฟิลด์ units_used ออกเพื่อป้องกันข้อผิดพลาดจาก Supabase Generated Column)
  const handleSave = async () => {
    ...
    try {
      ...
      // ตรวจสอบความถูกต้องหน้าบ้าน (ป้องกันการกรอกเลขน้อยกว่าครั้งก่อน ยกเว้นมิเตอร์ครบรอบ 4 หลักหมุนกลับมาเริ่มต้นใหม่)
      ...
      // ถอดฟิลด์ units_used ออกจากการ Insert ปล่อยให้ระบบฐานข้อมูลคำนวณอัตโนมัติเพื่อแก้เออร์เรอร์
