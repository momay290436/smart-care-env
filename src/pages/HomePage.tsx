...
const menuCards = [
  {
    path: "/dashboard",
    label: "แดชบอร์ด",
    desc: "ภาพรวมสถิติการใช้งาน กราฟรายวัน/เดือน และรายงานสรุป",
    icon: BarChart3,
    borderColor: "border-t-emerald-500",
    iconBg: "bg-emerald-500",
    statusDot: "bg-emerald-400",
    statusText: "ภาพรวมทั้งหมด",
    badgeKey: null,
  },
  {
    path: "/5s-hub",
    label: "5ส.",
    desc: "ระบบตรวจ 5ส ปฏิทินกำหนดการ และรายงานผลการตรวจ",
    icon: Clipboard,
    borderColor: "border-t-teal-500",
    iconBg: "bg-teal-500",
    statusDot: "bg-teal-400",
    statusText: "พร้อมตรวจ",
    badgeKey: "audits",
  },
  {
    path: "/maintenance-hub",
    label: "ระบบซ่อมบำรุง",
    desc: "แจ้งซ่อม ติดตามสถานะ และจัดการงานซ่อมบำรุง",
    icon: Wrench,
    borderColor: "border-t-orange-500",
    iconBg: "bg-orange-500",
    statusDot: "bg-orange-400",
    statusText: "ติดตามงาน",
    badgeKey: "tickets",
  },
  {
    path: "/waste",
    label: "จัดการข้อมูลขยะ",
    desc: "บันทึก วิเคราะห์ และคำนวณต้นทุนการจัดการขยะ",
    icon: Trash2,
    borderColor: "border-t-rose-500",
    iconBg: "bg-rose-500",
    statusDot: "bg-rose-400",
    statusText: "บันทึกข้อมูล",
    badgeKey: "waste",
  },
  {
    path: "/safety-hub",
    label: "ความปลอดภัย",
    desc: "ตรวจถังดับเพลิง แผนที่หนีไฟ และระบบอพยพ",
    icon: Shield,
    borderColor: "border-t-red-500",
    iconBg: "bg-red-500",
    statusDot: "bg-red-400",
    statusText: "ระบบพร้อม",
    badgeKey: "fireChecks",
  },
  {
    path: "/map-hub",
    label: "แผนที่และนำทาง",
    desc: "แผนที่อาคาร นำทาง และจัดการเส้นทาง",
    icon: Map,
    borderColor: "border-t-violet-500",
    iconBg: "bg-violet-500",
    statusDot: "bg-violet-400",
    statusText: "ใช้งานได้ทันที",
    badgeKey: null,
  },
  {
    path: "/hazmat",
    label: "คลัง HAZMAT",
    desc: "จัดการวัตถุอันตราย สารเคมี และ SDS",
    icon: FlaskConical,
    borderColor: "border-t-amber-500",
    iconBg: "bg-amber-500",
    statusDot: "bg-amber-400",
    statusText: "คลังสารเคมี",
    badgeKey: "chemicals",
  },
  {
    path: "/env-round",
    label: "ENV Round",
    desc: "เดินตรวจสิ่งแวดล้อมและความปลอดภัยประจำจุด",
    icon: Search,
  ...
  {
    path: "/water",
    label: "ระบบจัดการน้ำประปา",
    desc: "ตรวจคุณภาพน้ำ มิเตอร์น้ำ และระบบ FMS ตามมาตรฐาน สรพ.",
    icon: Droplets,
    borderColor: "border-t-blue-500",
    iconBg: "bg-blue-500",
    statusDot: "bg-blue-400",
    statusText: "Water & FMS",
    badgeKey: null,
  },
];
...
export default function HomePage() {
  ...
  return (
    <div className="pb-6">
      ...
      <div className="relative -mx-4 -mt-4 px-6 pt-10 pb-16 bg-gradient-to-br from-[hsl(195,80%,25%)] via-[hsl(187,75%,30%)] to-[hsl(170,60%,35%)] overflow-hidden">
        {/* Decorative circles */}
        ...
        <div className="relative text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight mt-3 leading-tight">
            ระบบจัดการ<br className="sm:hidden" />สิ่งแวดล้อม
          </h1>
          <p className="text-base text-white/70 mt-2 font-medium">เลือกเมนูด้านล่างเพื่อเริ่มใช้งาน</p>
        </div>
      </div>

      {/* Cards Grid - overlapping the hero */}
      <div className="-mt-10 px-1 space-y-5">
              ...
              >
                <div className="p-5 flex flex-col gap-4 h-full">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground mt-1 leading-relaxed line-clamp-2">{item.desc}</p>
                  </div>
        ...
        {isAdmin && (
          ...
          >
            <div className="p-5 flex items-center gap-5">
              <div className="w-12 h-12 rounded-xl bg-pink-500 flex items-center justify-center shadow-md flex-shrink-0">
                <Settings className="h-6 w-6 text-white" />
              </div>
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2">
                  <p className="text-lg font-bold text-foreground leading-tight">จัดการระบบ</p>
                  <span className="text-[10px] font-semibold bg-pink-100 text-pink-600 rounded-full px-2 py-0.5">Admin Only</span>
                </div>
                <p className="text-sm text-muted-foreground mt-1">บริหารจัดการผู้ใช้ ข้อมูลครุภัณฑ์ และการตั้งค่าระบบทั้งหมด</p>
              </div>
